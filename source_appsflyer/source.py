...
class InAppEvents(RawDataMixin, IncrementalAppsflyerStream):
    ...
    def path(
        ...
        return f"api/raw-data/export/app/{self.app_id}/in_app_events_report/v5"
...
class UninstallEvents(RawDataMixin, IncrementalAppsflyerStream):
    ...
    def path(
        ...
        return f"api/raw-data/export/app/{self.app_id}/uninstall_events_report/v5"
...
class Installs(RawDataMixin, IncrementalAppsflyerStream):
    ...
    def path(
        ...
        return f"api/raw-data/export/app/{self.app_id}/installs_report/v5"
...
class PartnersReport(AggregateDataMixin, IncrementalAppsflyerStream):
    ...
    def path(
        ...
        return f"api/agg-data/export/app/{self.app_id}/partners_report/v5"
...
class DailyReport(AggregateDataMixin, IncrementalAppsflyerStream):
    ...
    def path(
        ...
        return f"api/agg-data/export/app/{self.app_id}/daily_report/v5"
...
class GeoReport(AggregateDataMixin, IncrementalAppsflyerStream):
    ...
    def path(
        ...
        return f"api/agg-data/export/app/{self.app_id}/geo_by_date_report/v5"
...
class OrganicUninstallEvents(RawDataMixin, IncrementalAppsflyerStream):
    ...
    def path(
        ...
        return f"api/raw-data/export/app/{self.app_id}/organic_uninstall_events_report/v5"
...
class OrganicInstalls(RawDataMixin, IncrementalAppsflyerStream):
    ...
    def path(
        ...
        return f"api/raw-data/export/app/{self.app_id}/organic_installs_report/v5"
